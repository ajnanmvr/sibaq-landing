  ...
  return (
    <div className="md:px-52 flex flex-col justify-center items-center pt-20">
      <div>
        ...
        <div className="w-full  py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
          <div className="group h-64 w-60 p-6 flex flex-col gap-3 relative rounded-3xl bg-yellow border border-yellow-half hover:border-yellow bg-opacity-10">
          ...
          <div className="group h-64 w-60 p-6 flex flex-col gap-3 relative rounded-3xl bg-red border border-red-half hover:border-red bg-opacity-10">
          ...
          <div className="group h-64 w-60 p-6 flex flex-col gap-3 relative rounded-3xl bg-blue border border-blue-half hover:border-blue bg-opacity-10">
          ...
          <div className="group h-64 w-60 p-6 flex flex-col gap-3 relative rounded-3xl bg-green border border-green-half hover:border-green bg-opacity-10">
