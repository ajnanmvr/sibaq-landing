        ...
        <div className="flex justify-center gap-2 md:gap-4 items-center my-10 flex-wrap px-8">
            {
                NotificationData.map(({ title, category, time, link }, key) => (
                    <Link href={link} key={key} data-aos="fade-in" className="bg-blue md:text-center transition-all duration-300 hover:bg-opacity-20 hover:scale-[102%] bg-opacity-10 px-4 py-6 gap-4 rounded-[1.8rem] md:rounded-[70px] flex md:flex-col items-center md:justify-center w-full md:w-[19rem] md:min-h-[21rem]">
                        ...
                        <div className="flex flex-col md:items-center gap-2 md:gap-4">
                            ...
                            <div className="flex md:flex-col items-center md:justify-center gap-2 flex-wrap">
                                <p className="bg-blue bg-opacity-10 rounded-full inline px-3 md:px-4 py-0.5 font-light">{category}</p>
