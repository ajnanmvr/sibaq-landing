  ...
  return (
    <div className="flex justify-center gap-2 md:gap-4 items-center my-10 flex-wrap px-8">
      {NotificationData.map((notification, key) => (
        ...
        >
<div className="w-8">          <Bell className="rounded-full w-8 h-8 aspect-square bg-blue md:w-14 md:h-14" />

</div>          <div className="flex flex-col md:items-center gap-2 md:gap-4">
