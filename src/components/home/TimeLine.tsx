...
export default function TimeLine() {
  return (
    <div className="flex justify-center flex-col gap-2">
      <h3 className="font-semibold opacity-50 text-center tracking-tighter text-[4.2rem] inline-block text-transparent bg-clip-text bg-gradient-to-r from-yellow via-red to-g">
        Sibaq Timeline
      </h3>
      <div className="w-full flex justify-center">
        <p className="bg-blue inline-flex gap-2 justify-center items-center  text-center text-xl bg-opacity-10 rounded-full px-5 py-2 font-light">
          Venue 1
          <Image
            src={ArrowDown}
      ...
      <div className="relative">
        ...
        <div className="flex justify-center items-center my-10">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-10">
            ...
            <div className="flex flex-col items-center">
              <div className="relative flex justify-center items-center w-32 h-32 rounded-full border-8 bg-white border-red">
                <span className="text-gray-700 text-lg font-bold text-center">
                  March
                  <br />
                  <span className="text-5xl">25</span>
