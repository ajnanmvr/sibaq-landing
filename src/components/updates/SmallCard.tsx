...
export default function SmallCard({
  ...
  return (
    <Link
      href={data.url}
      className={`flex group gap-2 hover:bg-gradient-to-t from-transparent ${index % 5 === 0
        ? "via-yellow/10"
        : index % 5 === 1
          ? "via-red/10"
          : index % 5 === 2
    ...
    >
      ...
      <div
        className={`px-3 py-1 flex gap-1.5 items-center justify-center font-[470] border-[0.5px] border-black rounded-full transition-colors duration-300 ${index % 5 === 0
      ...
      > View More
        <RoundArrow className={`w-5 h-5 ${index % 5 === 0
