...
const PosterCampaign = () => {
  ...
  return (
    <div className="flex flex-col sm:flex-row my-3 mx-2 space-y-8 sm:space-y-0 p-10 bg-white shadow-lg rounded-3xl justify-between items-center sm:w-[40rem] w-96">
      
      <div className="container w-[20rem] sm:w-[15rem] bg-white rounded-3xl h-sreen">
        {/* <h1 className="text-xl mx-auto my-3">Poster Campaign</h1> */}
        {croppedImage ? (
          <div className="bg-contain bg-no-repeat bg-center relative poster">
            <img
              src="/campaign-poster.jpg"
              alt=""
              className=" top-0 left-0 w-full rounded-3xl"
            />
            <img
              src={croppedImage}
              alt=""
              className="rounded-t-full absolute top-[10.5rem] left-[49px] w-[5.3rem] sm:top-[7.8rem] sm:left-[2.26rem] sm:w-[3.98rem]"
            />
            <p
              className={`${nippo.className} capitalize text-[0.7rem] tracking-tight text-wrap leading-3 text-gray-600 absolute top-[263px] left-[170px] w-[100px] sm:top-[195px] sm:left-[127px] sm:w-[87px]`}
            >
              {inputValue}
            </p>
          </div>
          ...
          <p className="text-center">
            <img src="/campaign-poster.jpg" className="rounded-3xl" alt="" />
          </p>
        )}
      </div>
      <div className="flex flex-col w-[22rem] justify-start px-4 sm:pr-0 sm:pl-8">
        <h1 className={`${nippo.className} text-2xl text-center leading-7`}>Participating in <br /> Sibaq Poster Campaign</h1>
